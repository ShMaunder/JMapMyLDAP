 ...
 * @since       2.0
 */
class TCasesLdapextendedSearchread extends TPluginsTestcasesTestcase implements TPluginsTestcasesItestcase
{
	...
	public function runTests()
	{
		...
		$aa = new SHLdap(TCasesHelper::getLdapConfig(80));
		$aa->connect();
		$aa->proxyBind();
		...
		print_r(SHLdapHelper::getConfigIDs());

		$id = SHLdapHelper::getConfigId('home');
		print_r(SHLdapHelper::getClient($id));
