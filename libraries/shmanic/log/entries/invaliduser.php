 ...
 * @since       2.0
 */
class SHLogEntriesInvaliduser extends SHLogEntriesId
{
	/**
	 * Internal Error ID.
	 *
	...
	public function __construct(Exception $exception, $id = 0, $priority = JLog::INFO, $category = '', $date = null)
	{
		...
		// Translated ID with replacement on the username to save doing sprintf's everywhere
		$message = str_replace('[username]', $this->username, $exception->getMessage());
