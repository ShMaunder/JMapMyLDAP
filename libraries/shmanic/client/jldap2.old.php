...
class JLDAP2 extends JObject 
{
	 ...
	 * @since  1.0
	 */
	protected $connect_username = null;
	 ...
	 * @since  1.0
	 */
	protected $connect_password = null;
	...
	/**
	 * Holds the id to the successful authenticated instance
	 * 
	 * @var    integer
	 * @since  2.0
	 */
	 ...
	 * Class constructor.
	 *
	 * @param   JRegistry  $config  JRegistry parameters for use in this library. This
	...
	function __construct($config) 
	{
		...
		JFactory::getLanguage()->load('lib_jldap2', JPATH_SITE); //for errors
		
		// Add the LDAP logging for errors and information
		JLogLdapHelper::addLoggers();
	}
	
	/**
	* Get a instance of JLDAP2
	*
	* @param  $id      integer  The LDAP client identifier to load
	* @param  $config  array    An array or registry of configuration parameters
	*
	* @return  JLDAP2  Reference to a instance of JLDAP2
	* @since   2.0
	*/
	public static function getInstance($id = 0, $config = null)
	{
		
		if(!isset(self::$instances[$id])) {
			
			$configuration = is_null($config) ? LdapHelper::getConfig($id) : $config;
			
			if(!$configuration) {
				// Could not find this identifier	
				return false;
			}
			
			self::$instances[$id] = new self($configuration);
	...
	/**
	 * Kill and unset a JLDAP2 instance.
	 * 
	 * @param  integer  $id  Instance id to kill
	 * 
	 * @since   2.0
	 * @return  void
	 */
	...
	/**
	 * Sets the authenticated identifier instance. This
	 * is to set the instance that successfully 
	 * authenticated the user. This is only used during
	 * a user login. 
	 * 
	 * @param  integer  $id  The JLDAP2 instance id of the successful authentication 
	 * 
	 * @since   2.0
	 * @return  void
	 */
	public static function setAuthenticated($id) 
	{
		self::$authenticated = $id;	
	}
	
	/**
	 * Returns the authenticated instance id. See
	 * setAuthenticated() for more information.
	 * 
	 * @since   2.0
	 * @return  integer  Successful authenticated instance
	 */
