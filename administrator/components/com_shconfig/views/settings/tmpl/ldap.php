...
<form action="<?php echo JRoute::_('index.php?option=com_shconfig&task=settings.edit&layout=ldap'); ?>" method="post" name="adminForm" id="settings-form" class="form-validate">
	<div class="row-fluid">
	<div class="width-50 fltlft span6 form-horizontal">
		<fieldset class="adminform">
			<legend><?php echo JText::_('COM_SHCONFIG_SETTINGS_LDAP_TITLE'); ?></legend>
	...
	<div class="width-50 fltrt span6 form-horizontal">
		<fieldset class="adminform">
			<legend><?php echo JText::_('COM_SHCONFIG_SETTINGS_LDAP_INFO_TITLE'); ?></legend>
			<div class="adminformlist tab-content">
				<div class="tab-pane active" id="details">
					<div id="ldap-info"><?php echo JText::_('COM_SHCONFIG_SETTINGS_LDAP_INFO_TEXT'); ?></div>
				</div>
			</div>
		</fieldset>
	</div>
